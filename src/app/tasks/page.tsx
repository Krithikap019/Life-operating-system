...
const TAG_COLORS: Record<string, string> = {
  ...
  Learning: "bg-blue-50 text-brand-800 border-brand-200",
    ...
    <div className="flex h-screen overflow-hidden bg-[#F5F4F0]">
      ...
      <div className="flex flex-col flex-1 min-w-0 overflow-hidden">
        ...
        <div className="flex flex-1 min-h-0 overflow-hidden">
          ...
          {/* Tasks column — filter row + scrollable content */}
          <div className="flex-1 flex flex-col overflow-hidden">

            {/* Filter row — only above tasks column */}
          ...
          {/* AI Panel — starts aligned with filter row */}
          <AITaskPanel onAddTask={addTask} />
